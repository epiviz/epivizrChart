...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 891 }, { marker: 'pandoc', elapsed: 65 }, { marker: 'post-processor', elapsed: 12 }, { marker: 'pre-processor', elapsed: 7 }, { marker: 'render', elapsed: 1168 } ];

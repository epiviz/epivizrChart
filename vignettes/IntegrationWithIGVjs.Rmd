...
This vignette demonstrates one of the new components we added to epivizrChart, the Epiviz-IGV-Track. it is a web component implementing igv.js. 
...
Lets initialize an environment element to the following chromosome location and add a gene annotation track and a blacks track from the example datasets. 
...
Note: IGV.js has issues with the web browser embedded in R-Studio. Please open the markdown document in the webrowser from the system to visualize the data in igv.

...
settings <- list(
  ...
  useColorBy=FALSE,
  blockColorBy="")
blocks_track <- epivizChart(tcga_colon_blocks, chr="chr11", start=99800000, end=103383180, settings=settings)
blocks_track

colors <- RColorBrewer::brewer.pal(3, "Dark2")
lines_track <- epivizChart(tcga_colon_curves, chr="chr11", start=99800000, end=103383180, type="bp", columns=c("cancerMean","normalMean"), colors=colors)
lines_track
```
